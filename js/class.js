...
var Monster = /** @class */ (function (_super) {
    ...
    function Monster(x, y, id) {
        var _this_1 = _super.call(this, 0, 0, x, y, 0, { walking: { spritesPath: [''], animeTime: 1000 }, jumping: { spritesPath: [''], animeTime: 1000 }, attacking: { spritesPath: [''], animeTime: 1000 }, nothing: { spritesPath: [''], animeTime: 1000 } }) || this;
        if (id >= Monster.monsters.length)
            throw new Error('bad ID');
        var _this = new Monster.monsters[id]();
        MonstersElement.push(_this_1);
        _this_1.x = x;
        _this_1.y = y;
        return _this_1;
    }
...
Monster.monsters.push(/** @class */ (function (_super) {
    __extends(class_1, _super);
    function class_1() {
        return _super.call(this, 100, 100, 0, 0, 2, {
            walking: {
                spritesPath: [
    ...
    class_1.prototype.follow = function () {
        var maxFX = 10;
    };
    return class_1;
}(GameEntity)));
